...
public class CameraActivity extends AppCompatActivity {
    ...
    private PaddleLiteClassification paddleLiteClassification;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Utils.copyFileFromAsset(CameraActivity.this, "mobilenet_v2.nb", classificationModelPath);
        try {
            ...
            new Runnable() {
                ...
                public void run() {
                    synchronized (lock) {
                        if (runClassifier) {
                            // 开始预测前要判断相机是否已经准备好
                            if (getApplicationContext() != null && mCameraDevice != null && paddleLiteClassification != null) {
                                predict();
                            }
                        }
                    }
