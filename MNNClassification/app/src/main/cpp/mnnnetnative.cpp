...
extern "C" JNIEXPORT jlong JNICALL
Java_com_yeyupiaoling_mnnclassification_mnn_MNNNetNative_nativeCreateSession(
...
extern "C" JNIEXPORT jint JNICALL
Java_com_yeyupiaoling_mnnclassification_mnn_MNNNetNative_nativeRunSessionWithCallback(
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_yeyupiaoling_mnnclassification_mnn_MNNNetNative_nativeGetSessionInput(
...
extern "C" JNIEXPORT jlong JNICALL
Java_com_yeyupiaoling_mnnclassification_mnn_MNNNetNative_nativeGetSessionOutput(
        JNIEnv *env, jclass type, jlong netPtr, jlong sessionPtr, jstring name_) {
    auto net = (MNN::Interpreter *) netPtr;
    auto session = (MNN::Session *) sessionPtr;
    if (nullptr == name_) {
...
extern "C" JNIEXPORT void JNICALL
Java_com_yeyupiaoling_mnnclassification_mnn_MNNNetNative_nativeSetInputIntData(
...
extern "C" JNIEXPORT void JNICALL
Java_com_yeyupiaoling_mnnclassification_mnn_MNNNetNative_nativeSetInputFloatData(
...
Java_com_yeyupiaoling_mnnclassification_mnn_MNNNetNative_nativeConvertBufferToTensor(
...
extern "C" JNIEXPORT jboolean JNICALL
Java_com_yeyupiaoling_mnnclassification_mnn_MNNNetNative_nativeConvertBitmapToTensor(
